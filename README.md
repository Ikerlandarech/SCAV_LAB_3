...
#### FOR THIS LAB I'VE USED: bbb9s.mp4 segment and bbb60s.mp4 videos which can be found into the _InputVideos_ folder in this repository. I know code should speak for us and videos doesn't necessarily need to be uploaded into the repo but this way I can run the script/check the outputs on multiple devices.
